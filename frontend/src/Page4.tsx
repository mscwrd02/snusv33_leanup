...
export function Page4(){
    ...
    function cardClick(index: number){
        setCardClickedArray(prevState => {
            ...
            if(updatedArray[0]||updatedArray[1]||updatedArray[2]||updatedArray[3]) setCheckClicked(true);
    ...
    return(
        <Page4Container>
            ...
            <Extra>렌트카 여행 시 <span>2~3개</span>,<br/>뚜벅이 여행 시 <span>1~2개</span>를 추천해요!</Extra>

            <Selection>
                <Card cardClicked={cardClickedArray[0]} onClick={() => cardClick(0)}>
                    <Where>
                        노을이 아름다운<br/><Direction cardClicked={cardClickedArray[0]}>제주 서부</Direction>
                    </Where>
                    <Example>
                ...
                <Card cardClicked={cardClickedArray[1]} onClick={() => cardClick(1)}>
                    <Where>
                        신비로운 대자연의<br/><Direction cardClicked={cardClickedArray[1]}>제주 동부</Direction>
                    </Where>
                    <Example>
                ...
                <Card cardClicked={cardClickedArray[2]} onClick={() => cardClick(2)}>
                    <Where>
                        뚜벅이를 위한<br/><Direction cardClicked={cardClickedArray[2]}>제주 북부</Direction>
                    </Where>
                    <Examplea>
                ...
                <Card cardClicked={cardClickedArray[3]} onClick={() => cardClick(3)}>
                    <Where>
                        다양한 액티비티의<br/><Direction cardClicked={cardClickedArray[3]}>제주 남부</Direction>
                    </Where>
                    <Example>
